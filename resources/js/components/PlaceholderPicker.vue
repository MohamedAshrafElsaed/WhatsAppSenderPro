        ...
        <CardContent>
            <div class="space-y-2">
                ...
                >
                    ...
                    <div :class="isRTL() ? 'ml-auto mr-0' : 'mr-auto ml-0'" class="flex items-center gap-2">
                        <Badge variant="secondary">{{ placeholder.value }}</Badge>
                        <Copy :class="isRTL() ? 'ml-2' : 'mr-2'" class="size-4" />
                    </div>
                </Button>
            </div>
        </CardContent>
