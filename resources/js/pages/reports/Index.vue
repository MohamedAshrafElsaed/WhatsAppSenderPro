        ...
        >
            ...
            >
                <Heading
                    :description="
                        t(
                            'reports.description',
                            'Comprehensive analytics and insights for your WhatsApp campaigns',
                        )
                    "
                    :title="t('reports.title', 'Reports & Analytics')"
                />
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold">
                            {{ formatNumber(overview.total_campaigns) }}
                        </div>
                        <p class="text-xs text-muted-foreground">
                            {{ overview.active_campaigns }}
                            {{ t('reports.active', 'active') }},
                            {{ overview.completed_campaigns }}
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        >
                            ...
                            <span>{{
                                t('reports.messages_sent', 'Messages sent')
                            }}</span>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold">
                            {{ formatNumber(overview.total_contacts) }}
                        </div>
                        <p class="text-xs text-muted-foreground">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-[#25D366]">
                            {{ overview.average_success_rate }}%
                        </div>
                        <p class="text-xs text-muted-foreground">
                            {{
                                t(
                                    'reports.delivery_success',
            ...
            <Card>
                ...
                <CardContent>
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        class="mt-1 flex flex-wrap gap-4 text-sm text-muted-foreground"
                                    >
                                        <span
                                ...
                                >
                                    <div
                                        class="text-lg font-bold text-[#25D366]"
                                    >
                        ...
                        <div
                            v-if="campaignPerformance.length === 0"
                            class="py-8 text-center text-muted-foreground"
                        >
                            {{
                                t(
                                    'reports.no_campaigns',
                    ...
                    <div class="space-y-3">
                        ...
                        >
                            ...
                            <div class="flex items-center gap-4 text-sm">
                                <span
                                    class="flex items-center gap-1 text-[#25D366]"
                                >
                                ...
                                <span class="font-medium"
                                    >{{ trend.success_rate }}%</span
                                >
                            </div>
                        </div>

                        <div
                            v-if="messageTrends.length === 0"
                            class="py-8 text-center text-muted-foreground"
                        >
                            {{
                                t(
                        ...
                        >
                            ...
                            <span class="flex items-center gap-2">
                                ...
                                <span class="text-xs text-muted-foreground">{{
                                    t('reports.new_contacts', 'new contacts')
                                }}</span>
                            </span>
                        </div>

                        <div
                            v-if="contactGrowth.length === 0"
                            class="py-8 text-center text-muted-foreground"
                        >
                            {{
                                t(
