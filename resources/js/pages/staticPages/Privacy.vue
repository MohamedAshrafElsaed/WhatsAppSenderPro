            ...
            <div class="container mx-auto px-4">
                <div class="mx-auto max-w-3xl text-center">
                    ...
                    <p class="mt-6 text-lg text-muted-foreground">
                        {{ t('static.privacy.subtitle') }}
                    </p>
                    <p class="mt-2 text-sm text-muted-foreground">
                        {{ t('static.privacy.last_updated') }}
                    </p>
                </div>
            </div>
        </section>
                ...
                <div class="mx-auto max-w-4xl">
                    <Card>
                        ...
                        >
                            ...
                            <p>{{ t('static.privacy.section4_text') }}</p>

                            <h2>{{ t('static.privacy.section5_title') }}</h2>
                            <p>{{ t('static.privacy.section5_text') }}</p>

                            <h2>{{ t('static.privacy.section6_title') }}</h2>
                            <p>{{ t('static.privacy.section6_text') }}</p>

                            <h2>{{ t('static.privacy.section7_title') }}</h2>
                            <p>{{ t('static.privacy.section7_text') }}</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
